...
class ExcludeDir extends AbstractFieldArray
{
    const EXCLUDE_DIR_CONFIG_DEFAULT_VALUE = [
        'original_images_dir' => ['folder' => 'pub/media/po_image_optimization_original_images'],
        'temp_images_dir' => ['folder' => 'pub/media/po_image_optimization_temp_images'],
        'captcha_dir' => ['folder' => 'pub/media/captcha'],
        'import_dir' => ['folder' => 'pub/media/import'],
    ];
