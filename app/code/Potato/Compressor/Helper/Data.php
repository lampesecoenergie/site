...
class Data
{
    ...
    const IMAGE_PLACEHOLDER = "data:image/svg+xml;base64,PHN2ZyB4bWxucz0naHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmcnIHZpZXdCb3g9JzAgMCAzIDInPjwvc3ZnPg==";

    const LIB_JS_BUILD_SCRIPT = 'mage/requirejs/static.js';
    const REQUIREJS_STORAGE_DIR = 'requirejs';

    const DATA_ATTRIBUTE_FOR_FAST_INIT = 'data-po-cmp-fast';
