...
class ProfileProduct extends \Magento\Framework\Model\AbstractModel
{
    ...
    {
        $this->_init('Ced\RueDuCommerce\Model\ResourceModel\ProfileProduct');
    }
    ...
    {
        return $this->getResource('Ced\RueDuCommerce\Model\ResourceModel\ProfileProduct\Collection');
    }
     ...
     * @return bool|\Ced\RueDuCommerce\Model\ProfileProduct
     */
