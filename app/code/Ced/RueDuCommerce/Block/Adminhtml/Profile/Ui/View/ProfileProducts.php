...
class ProfileProducts extends \Magento\Backend\Block\Template
{
     ...
     * @var string
     */
    protected $_template = 'Ced_RueDuCommerce::profile/profile_products.phtml';
    ...
    public function getBlockGrid()
    {
        if (null === $this->blockGrid) {
            $this->blockGrid = $this->getLayout()->createBlock(
                \Ced\RueDuCommerce\Block\Adminhtml\Profile\Ui\View\Grid\Product::class,
                'rueducommerce.profile.products.grid'
            );
        }
 ...
 /**
    ...
    {
        return $this->registry->registry('rueducommerce_profile');
    }
}
