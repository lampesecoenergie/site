...
namespace Ced\RueDuCommerce\Block\Adminhtml\Profile\Edit\Tab;

use RueDuCommerceSdk\Product;
...
class Mapping extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('category', ['legend' => __('RueDuCommerce Category Listing')]);
        ...
        $locations->setRenderer(
            $this->getLayout()->createBlock('Ced\RueDuCommerce\Block\Adminhtml\Profile\Edit\Tab\Attribute\CategoryJs')
        );

        $fieldset = $form->addFieldset(
            'attributes_fieldset',
            [
                'legend' => __('RueDuCommerce Attributes Mapping')
            ]
        );
        ...
        $locations->setRenderer(
            $this->getLayout()->createBlock(
                'Ced\RueDuCommerce\Block\Adminhtml\Profile\Edit\Tab\Attribute\Attributes',
