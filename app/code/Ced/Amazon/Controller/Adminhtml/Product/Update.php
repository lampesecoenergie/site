...
class Update extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if (isset($filters)) {
            ...
            $reasons = [];
            $message = 'Product(s) update request processed successfully.';
            if ($throttle) {
            ...
            $response = $this->product->update($ids, $throttle, \Amazon\Sdk\Base::OPERATION_TYPE_PARTIAL_UPDATE);
            ...
            if ($response) {
                ...
                $this->messageManager->addComplexErrorMessage(
                    'addAmazonError',
                    [
                        'message' => 'Product Feed update failed.',
                        'reasons' => [
