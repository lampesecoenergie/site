...
class Image extends \Magento\Backend\App\Action
{
     ...
     * @param \Ced\Amazon\Helper\Product\Image $image
    ...
    public function execute()
    {
        ...
        if (isset($filters)) {
            ...
            $message = 'Product(s) image request processed successfully.';
            if ($throttle) {
            ...
            $response = $this->image->update($ids, $throttle);
        }
        ...
        if ($response) {
            ...
            $this->messageManager->addComplexErrorMessage(
                'addAmazonError',
                [
                    'message' => 'Feed image upload failed.',
