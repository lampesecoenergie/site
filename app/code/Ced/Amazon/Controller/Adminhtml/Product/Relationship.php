 ...
 */
class Relationship extends \Magento\Backend\App\Action
{
    /**
     ...
     * @param \Ced\Amazon\Helper\Product\relationship $relationship
    ...
    public function __construct(
        ...
        \Ced\Amazon\Helper\Product\Relationship $relationship,
    ...
    public function execute()
    {
        ...
        if (isset($filters)) {
            ...
            $message = 'Product(s) relationship request processed successfully.';
            ...
            $response = $this->relationship->update($ids, $throttle);
        }
        ...
        if ($response) {
            ...
            $this->messageManager->addComplexErrorMessage(
                'addAmazonError',
                [
                    'message' => 'Feed relationship upload failed.',
