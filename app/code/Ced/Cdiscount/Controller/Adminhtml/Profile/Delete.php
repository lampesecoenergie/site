...
class Delete extends \Magento\Customer\Controller\Adminhtml\Group
{
    ...
    public function execute()
    {
        ...
        if ($code) {
            $model = $this->_objectManager->create('Ced\Cdiscount\Model\Profile')->getCollection()->addFieldToFilter('profile_code', $code);
        ...
        return $this->_redirect('cdiscount/profile/index');
    }
}
