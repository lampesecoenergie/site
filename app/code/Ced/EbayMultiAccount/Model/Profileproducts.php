...
class Profileproducts extends \Magento\Framework\Model\AbstractModel
{
    ...
    {
        $this->_init('Ced\EbayMultiAccount\Model\ResourceModel\Profileproducts');
    }
    ...
    {
        return $this->getResource('Ced\EbayMultiAccount\Model\ResourceModel\Profileproducts\Collection');
    }
