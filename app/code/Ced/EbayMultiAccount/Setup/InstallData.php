...
class InstallData implements InstallDataInterface
{
    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (!$this->eavAttribute->getIdByCode('catalog_product', 'ebay_domestic_shipping')) {
            $eavSetup->addAttribute(
                'catalog_product',
                'ebay_domestic_shipping',
                [
                    'group' => 'eBay',
                    'input' => 'text',
                    'type' => 'varchar',
                    'label' => 'Ebay Domestic Shipping',
                    'backend' => 'Ced\EbayMultiAccount\Model\Product\Attribute\Backend\MultiShipping',
                    'sort_order' => 25,
                    'visible' => true,
                    'required' => false,
                    'user_defined' => true,
