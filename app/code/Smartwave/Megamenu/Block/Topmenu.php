    ...
    public function getSubmenuItemsHtml($children, $level = 1, $max_level = 0, $column_width=12, $menu_type = 'fullwidth', $columns = null)
    {
        ...
        if(!$max_level || ($max_level && $max_level == 0) || ($max_level && $max_level > 0 && $max_level-1 >= $level)) {
            ...
            foreach($children as $child) {
                ...
                $category1 = $objectManager->create('Magento\Catalog\Model\Category')->load($child->getId());
                $_outputhelper    = $objectManager->create('Magento\Catalog\Helper\Output');
                $_imgHtml   = '';
                if ($_imgUrl = $category1->getImageUrl()) {
                    $_imgHtml = '<span class="top-category-image" ><img class="lazy" style="width: 50px; height: 50px; display: inline;" width="50" height="50" src="'.$_imgUrl.'"></span>';
                    $_imgHtml = $_outputhelper->categoryAttribute($category1, $_imgHtml, 'image');
                }*/
                //end
                ...
                if (!$sw_menu_hide_item) {
                    ...
                    //$html .= '<a style="display: flex; justify-content:left; flex-direction: row;" href="'.$this->_categoryHelper->getCategoryUrl($child).'" title="'.$child->getName().'">'.$_imgHtml;
					$html .= '<a style="display: flex; justify-content:left; flex-direction: row;" href="'.$this->_categoryHelper->getCategoryUrl($child).'" title="'.$child->getName().'">';
                    if ($level > 1 && $sw_menu_icon_img)
            ...
            if(!$sw_menu_hide_item) {
                ...
                if(count($children) > 0 || (($menu_type=="fullwidth" || $menu_type=="staticwidth") && ($menu_top_content || $menu_left_content || $menu_right_content || $menu_bottom_content))) {
                    ...
                    if(count($children) > 0 || (($menu_type=="fullwidth" || $menu_type=="staticwidth") && ($menu_left_content || $menu_right_content))) {
						...
						///////////////////////////kd custom start///////////////////////////////
						if($category->getId()=='139xxx'){
						//kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk
						$html .= '<div class="level0 submenu"><div class="container"><div class="row"><ul class="subchildmenu col-md-12 mega-columns columns4"><li class="ui-menu-item level1 "><a style="display: flex; justify-content:left; flex-direction: row;" href="https://magento2.lampesecoenergie.aquaray.com/spot-encastrable/spot-led-220v.html" title="Spot Encastrable LED 230V"><span class="top-category-image"><img class="lazy" style="width: 50px; height: 50px; display: inline;" width="50" height="50" src="https://magento2.lampesecoenergie.aquaray.com/pub/media/catalog/category/GROUP.jpg"></span><span>Spot Encastrable LED 230V</span></a></li><li class="ui-menu-item level1 "><a style="display: flex; justify-content:left; flex-direction: row;" href="https://magento2.lampesecoenergie.aquaray.com/spot-encastrable/plafonnier-et-dalle-led.html" title="Plafonnier et Dalle LED"><span>Plafonnier et Dalle LED</span></a></li><li class="ui-menu-item level1 "><a style="display: flex; justify-content:left; flex-direction: row;" href="https://magento2.lampesecoenergie.aquaray.com/spot-encastrable/spot-bain-et-douche-etanche.html" title="Spot Bain et Douche Etanche"><span class="top-category-image"><img class="lazy" style="width: 50px; height: 50px; display: inline;" width="50" height="50" src="https://magento2.lampesecoenergie.aquaray.com/pub/media/catalog/category/Spot_Encastrable_Etanche_IP65_11.jpg"></span><span>Spot Bain et Douche Etanche</span></a></li><li class="ui-menu-item level1 "><a style="display: flex; justify-content:left; flex-direction: row;" href="https://magento2.lampesecoenergie.aquaray.com/spot-encastrable/fixation-spot-encastrable.html" title="Fixation Spot Encastrable"><span class="top-category-image"><img class="lazy" style="width: 50px; height: 50px; display: inline;" width="50" height="50" src="https://magento2.lampesecoenergie.aquaray.com/pub/media/catalog/category/fixation_spot_compil.jpg"></span><span>Fixation Spot Encastrable</span></a></li><li class="ui-menu-item level1 "><a style="display: flex; justify-content:left; flex-direction: row;" href="https://magento2.lampesecoenergie.aquaray.com/spot-encastrable/acccessoires-spot.html" title="Acccessoires Spot"><span>Acccessoires Spot</span></a></li><li class="ui-menu-item level1 "><a style="display: flex; justify-content:left; flex-direction: row;" href="https://magento2.lampesecoenergie.aquaray.com/spot-encastrable/lot-spot-encastrable.html" title="Lot Spot Encastrable"><span class="top-category-image"><img class="lazy" style="width: 50px; height: 50px; display: inline;" width="50" height="50" src="https://magento2.lampesecoenergie.aquaray.com/pub/media/catalog/category/lot-spot-encastrable_1.jpg"></span><span>Lot Spot Encastrable</span></a></li><li class="ui-menu-item level1 "><a style="display: flex; justify-content:left; flex-direction: row;" href="https://magento2.lampesecoenergie.aquaray.com/spot-encastrable/spot-encastrable-bbc.html" title="Spot Encastrable BBC"><span>Spot Encastrable BBC</span></a></li></ul></div></div></div>';
