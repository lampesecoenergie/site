...
class Latest extends \Magento\Framework\View\Element\AbstractBlock implements DataProviderInterface
{
    /**
    ...
    public function getRssData()
    {
        ...
        $latestpagerss = $this->_blogHelper->getConfig("general_settings/latestpagerss");
        if(!$latestpagerss){
            return [
