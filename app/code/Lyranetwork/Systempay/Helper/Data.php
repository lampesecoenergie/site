...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    const METHOD_SOFORT = 'systempay_sofort';

    const METHOD_POSTFINANCE = 'systempay_postfinance';
    ...
    public function getCommonConfigData($field, $storeId = null)
    {
        ...
        return $this->scopeConfig->getValue('systempay/general/' . $field, ScopeInterface::SCOPE_STORE, $storeId);
    }
     ...
     *
     * @throws \Lyranetwork\Systempay\Model\WsException
     */
    public function checkWsRequirements()
    {
        if (! extension_loaded('soap')) {
            throw new \Lyranetwork\Systempay\Model\WsException(
