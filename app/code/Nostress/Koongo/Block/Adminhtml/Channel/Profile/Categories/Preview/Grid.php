...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareCollection() {
    	...
    	$select->joinLeft(
    			array($channelCategoriesTableAlias => $channelCategoriesTable),
    			$condition,
    			['name','path','id']
    	);
    	...
    	$select->joinLeft(
    			array($catalogProductEntityTableAlias => $catalogProductEntityTable),
		    	$condition,
		    	['sku']
    	);    	
    	...
    	if($this->checkTableExists($catalogProductFlatTable))
    	{
	    	...
	    	$select->joinLeft(
	    			array($catalogProductFlatTableAlias => $catalogProductFlatTable),
	    			$condition,
	    			['product_name' => 'name']
	    	);
    	}
