...
class Index extends \Nostress\Koongo\Controller\Adminhtml\Channel\Profile
{
    ...
    public function execute()
    {
        ...
        if (empty($configTest) && $this->version->isServerConfigUpdatable(true)) {
            ...
            return $resultRedirect->setPath('koongo/license/updateserverconfig', [ 'eei'=>true]);
        }
    ...
    protected function _checkLicense()
    {
        ...
        } else //License valid
        {
            ...
            // TODO - nevim jestli mam pridavat - @jirka: zatim pridavat nebudem
    //         $showKaasInfo = $this->version->getModuleConfig (Version::PARAM_SHOW_KAAS_INFO);
    //         if($showKaasInfo)
    //         {
    //             $this->messageManager->addNotice(__('Try our new product for Magento - Koongo as a Service! All the cool features from the Koongo Connector you are using now bundled with automatic product submission, faster support and performance tracking! Sign up for FREE 30 days Trial. Learn more and sign up at <a href="%1" target="_blank">www.koongo.com/pricing.html#magento</a>. <a href="%2">Hide this message</a>.',"http://www.koongo.com/pricing.html#magento",Mage::helper("adminhtml")->getUrl("*/*/hideKaasMessage")));
    //         }
