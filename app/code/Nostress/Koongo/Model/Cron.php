...
class Cron  extends \Nostress\Koongo\Model\AbstractModel
{
	...
	* Apply cron rules and adjust schedule records for export profile execution.
	...
	protected function getScheduledIntervals()
	{
		...
		$lastRunTimeFormated = $this->helper->getModuleConfig(\Nostress\Koongo\Helper\Data::PARAM_CRON_LAST_RUN);	
		$this->helper->setModuleConfig(\Nostress\Koongo\Helper\Data::PARAM_CRON_LAST_RUN,$timeFormated);
