...
class Simple  extends \Nostress\Koongo\Model\AbstractModel
{
	...
	const PARAM_API_URL_SECURE = 'https://www.koongo.com/api/2.0/koongo/';
	const PARAM_API_URL_UNSECURE = 'https://www.koongo.com/api/2.0/koongo/';
	
	// base server config url
	const PARAM_SERVER_CONFIG_JSON_URL = 'https://www.koongo.com/media/ChannelCache/ServerConfig.json';
