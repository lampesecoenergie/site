...
namespace Magetop\Productslider\Block\Adminhtml\Slider;
...
/**
 * Class Edit
 * @package Magetop\Productslider\Block\Adminhtml\Slider
 */
class Edit extends Container
{
    ...
    {
        return $this->_coreRegistry->registry('magetop_productslider_slider');
    }
    ...
    {
        $this->_objectId   = 'id';
        $this->_blockGroup = 'Magetop_Productslider';
