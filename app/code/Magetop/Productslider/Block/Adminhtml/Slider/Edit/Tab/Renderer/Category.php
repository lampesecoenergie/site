...
namespace Magetop\Productslider\Block\Adminhtml\Slider\Edit\Tab\Renderer;
...
/**
 * Class Category
 * @package Magetop\Productslider\Block\Adminhtml\Slider\Edit\Tab\Renderer
 */
class Category extends Multiselect
{
                            ...
                            "sliderCategory": {
                                ...
                                "children": {
                                    "slider_select_category": {
                                        "component": "Magetop_Productslider/js/components/new-category",
                                        "config": {
                                            "filterOptions": true,
                                            "disableLabel": true,
                                            "chipsEnabled": true,
    ...
    {
        $isNotAllowed = !$this->authorization->isAllowed('Magetop_Productslider::category');
