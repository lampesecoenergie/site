...
//            return $this->resultRedirectFactory->create()->setPath('catalog/product/', ['_current' => true]);
            return $this->resultRedirectFactory->create()->setPath('productmanage/product/index', ['_current' => true]);
        }
...
//            ->setPath('catalog/product/', ['store' => $this->attributeHelper->getSelectedStoreId()]);
        return $this->resultRedirectFactory->create()
            ->setPath('productmanage/product/index', ['store' => $this->attributeHelper->getSelectedStoreId()]);
    }
    ...
    {
        return $this->_authorization->isAllowed('Iksanika_Productmanage::ma_update_attributes');
    }
}
