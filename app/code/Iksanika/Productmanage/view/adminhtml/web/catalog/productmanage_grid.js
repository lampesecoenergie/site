...
varienGridMassaction.prototype = {
    ...
    findCheckbox: function(evt) {
        if(['a', 'input', 'select',
'textarea', 'img'
            ].indexOf(Event.element(evt).tagName.toLowerCase())!==-1) {
            return false;
        }
        checkbox = false;
...
//var title = jQuery('tr input[name=product][value=5]').parent().parent().parent().attr('title');
//jQuery("tr[title='http://46.101.251.64/admin/catalog/product/edit/id/5/key/8b96f96d577a8fc5613d067679182ccfe6aa0f81e0c65be5ce5e41427fab9aa1/'] input[name=qty]");
